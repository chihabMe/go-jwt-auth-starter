...
func DeleteRefreshToken(ctx context.Context, refreshToken string, userId uuid.UUID) error {
	key := fmt.Sprintf("%s:%s", userId, refreshToken)
	//key := fmt.Sprintf("%s", userId)
...
func GetRefreshToken(ctx context.Context, refreshToken string, userId uuid.UUID) (string, error) {
	key := fmt.Sprintf("%s:%s", userId, refreshToken)
	//key := fmt.Sprintf("%s", userId)
...
func GetRefreshTokenExpiration(ctx context.Context, refreshToken string, userId uuid.UUID) time.Duration {
	key := fmt.Sprintf("%s:%s", userId, refreshToken)
	//key := fmt.Sprintf("%s", userId)
